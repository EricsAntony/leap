              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
                    <div class="text">
                      <h2>A new class has been created. Please do check.</h2>
                    </div>
                  </td>
                </tr>
                <tr>
...
$sql_query = "SELECT * FROM `student` where `s_batch` = '$batch' and `s_yoa` = '$yoa'";
...
while($row = mysqli_fetch_assoc($res))
{
 // echo $row['email'];
  ...
  $sql = "INSERT INTO class (c_name,c_batch,c_yoa,c_tid) VALUES ('$name','$batch','$yoa','$tid')";
