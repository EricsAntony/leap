...
$targetfolder = "notes_folder/";
$targetfolder = $targetfolder . basename($_FILES['as_file']['name']);
move_uploaded_file($_FILES['as_file']['tmp_name'], $targetfolder);


$sql = "INSERT INTO notes (n_subid,n_date,n_name,n_fname) VALUES ('$sid',NOW(),'$file_name','$newfilename')";
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
                  <div class="text">
                    <h2>'.$r['sub_name'].' notes has been uploaded . Please do check.</h2>
                  </div>
                </td>
              </tr>
              <tr>
                <td style="text-align: center;">
                  <div class="text-author">
                    <img src="https://png.pngtree.com/png-clipart/20190920/original/pngtree-sticky-paper-sticky-sticky-note-png-image_4664401.jpg" alt="" style="width: 100px; max-width: 600px; height: auto; margin: auto; display: block;">
                   </div>
                </td>
              </tr>
            </table>
