            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="open"><a href="s_index.php"><i class="zmdi zmdi-face"></i><span>My classes</span></a></li>
                            <li><a href="s_viewAssignment.php?sub_id=<?php echo base64_encode($subid) ?>"><i class="zmdi zmdi-assignment"></i><span>Assignments</span></a></li>          
                            <li><a href="s_resources.php?sub_id=<?php echo base64_encode($subid) ?>"><i class="zmdi zmdi-assignment-o"></i><span>Question papers</span></a></li>          
                            <li><a href="#" data-toggle="modal" data-target="#internalModal"><i class="zmdi zmdi-border-color"></i><span>View internal mark</span></a></li>          
