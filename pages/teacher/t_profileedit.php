        ...
        <div class="block-header">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">                
                    ...
                    <a href="t_profile.php" class="btn btn-info btn-icon float-right"><i class="zmdi zmdi-check"></i></a>
                </div>
            </div>
        </div> 
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <input type="hidden" class="form-control" value="<?php echo $row['t_id'];?>" name="tid" id="t_id">
                                        <input type="text" class="form-control" placeholder="Name" value="<?php echo $row['t_name'];?>" name="tname" id="t_name">
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control" placeholder="Email" value="<?php echo $row['t_email'];?>" name="temail" id="t_email">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Phone" value="<?php echo $row['t_phn'];?>" name="tphn" id="t_phn">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Password" value="<?php echo base64_decode($row['t_pass']);?>" name="tpass" id="t_pass">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <input type="submit" class="btn btn-primary" value = "Save changes" name="save" id="update_profile">
                                </div>
                                </form>
                            </div>
                        </div>
