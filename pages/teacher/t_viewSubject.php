                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="card">
                                    ...
                                    <a href="t_notes.php?sub_id=<?php echo base64_encode($sub_id) ?>">
                                        <img src="assets/images/subject.png" alt="Product" class="img-fluid cp_img" /></a>
                                        <div class="product_details">
                                            <center>
                                                <h6><a href="t_notes.php?sub_id=<?php echo base64_encode($sub_id) ?>">
                                                        <?php echo $sub_name; ?>
                                                    </a></h6>
                                            </center>
