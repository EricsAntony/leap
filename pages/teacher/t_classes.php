                ...
                <div class="block-header">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-6 col-sm-12">
                                    <a class="btn btn-primary float-right" href="#" data-toggle="modal" data-target="#createClassModal">Create a class</a>
                        </div>
                    </div>
                </div>
                <span id="here">
                                                    ...
                                                    <div class="product details">
                                                        ...
                                                        <div class="action">
                                                            <a class="btn btn-primary waves-effect"
                                                                href="t_viewSubject.php?c_id=<?php echo base64_encode($c_id) ?>">ENTER</a>
                                                            
                                                            <button class="btn btn-info waves-effect" type="button"
                                                                id="updateButton" data-toggle="modal" data-target="#updateClassModal"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form_validation1" method="POST">
                            ...
                            <div class="form-group form-float">
                            <select class="form-control show-tick ms select2"
                                                            data-placeholder="Select" name="batch" id="c_batch">
                    ...
                    <div class="modal-body">
                        <form id="form_validation1" method="POST">
                            ...
                            <div class="form-group form-float">
                                ...
                                ?>
                            <select class="form-control show-tick ms select2"
                                                            data-placeholder="Select" id="cu_yoa">
                                                            <option disabled selected hidden>Year of admission</option>
                                                            <?php
                                                            while($roww = mysqli_fetch_assoc($r))
                                                            {
                            ...
                            <div class="form-group form-float">
                            <select class="form-control show-tick ms select2"
                                                            data-placeholder="Select" name="batch" id="cu_batch">
                                                            <option disabled selected hidden>Batch</option>
                                                            <option>A</option>
                                                            <option>B</option>
                                                            <option>C</option>
