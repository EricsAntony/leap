        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="open"><a href="t_viewQuiz.php?c_id=<?php echo $c_id ?>"><i
                                class="zmdi zmdi-puzzle-piece"></i><span>Quizzes</span></a></li>
                    <li class="open"><a href="t_chat.php?c_id=<?php echo base64_encode($c_id) ?>"><i
                                class="zmdi zmdi-email-open"></i><span>Discussion Forum</span></a></li>
                    <li class="open"><a href="t_announcement.php?c_id=<?php echo base64_encode($c_id) ?>"><i
            ...
            <div class="body_scroll">
                ...
                <div class="container-fluid">
                    ...
                    if ($i > 0) {
                        ...
                        ?>
                        <input type="submit" id="publish" value="publish" disabled class="btn btn-primary">
                        <?php
                    }
                    ?>
                </div>
