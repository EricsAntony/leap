            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li><a href="t_addmarks.php?sub_id=<?php echo base64_encode($subid) ?>"><i
                                class="zmdi zmdi-border-color"></i><span>Internal Marks</span></a></li>
                        ...
                        <div class="col-lg-7 col-md-6 col-sm-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="t_notes.php?sub_id=<?php echo base64_encode($subid); ?>"> Notes</a>
                                </li>
                                                ...
                                                while ($row = mysqli_fetch_assoc($res)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="hidden" value=<?php echo $subid ?> name="subid[]">
                                                            <input type="hidden" value=<?php $sid = $row['s_id'];
                                                            echo $row['s_id'] ?> name="sid[]">
                                                            <?php
                                                            ...
                                                            <input type="text" name="first[]"
                                                                value="<?php if (isset($rw['i_first']))
                                                                    echo $rw['i_first']; ?>"
                                                                class="form-control" placeholder="Not available">
                                                        </td>
                                                        <td><input type="text" name="second[]"
                                                                value="<?php if (isset($rw['i_second']))
                                                                    echo $rw['i_second']; ?>"
                                                                class="form-control" placeholder="Not available"></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
