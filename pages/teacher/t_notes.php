                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-6 col-sm-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="t_viewSubject.php?c_id=<?php echo base64_encode($row['sub_cid']);?>">Subjects</a></li>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group form-float">
                        <input type="hidden" id="n_subid" class="form-control" value=<?php echo $subid; ?>>
                            <input type="file" id="n_file" name="file" class="form-control file" onchange="fileValidation()" placeholder="Choose file"
                            required>
                        </div>
