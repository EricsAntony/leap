                ...
                <span id="here">
                  ...
                  $i=1;
                    while ($row = mysqli_fetch_array($res)) {
                        ...
                        $query = "select * from quiz_answers where qa_sid='$s_id' and qa_qtid=".$row['qt_id'];
                                                ...
                                                <div class="col-xl-9 col-lg-8 col-md-12">
                                                    <div class="product details">
                                                        <h3 class="product-title mb-0">
                                                            <?php echo $i.") ".$row['qt_question'] ?>
                                                        </h3>
                                                        <h5 class="price mt-0">
                                                            <?php
                                                                if($row['qt_ans1'] == $row['qt_crct'])
                                                                {
                                                                    echo '<h5 class="txt">'.$row['qt_ans1'].' </h5>';
                                                                }
                                                                else
                                                                {
                                                                    echo '<h5>'.$row['qt_ans1'].' </h5>';
                                                                }

                                                                if($row['qt_ans2'] == $row['qt_crct'])
                                                                {
                                                                    echo '<h5 class="txt">'.$row['qt_ans2'].' </h5>';
                                                                }
                                                                else
                                                                {
                                                                    echo '<h5>'.$row['qt_ans2'].' </h5>';
                                                                }

                                                                if($row['qt_ans3'] == $row['qt_crct'])
                                                                {
                                                                    echo '<h5 class="txt">'.$row['qt_ans3'].' </h5>';
                                                                }
                                                                else
                                                                {
                                                                    echo '<h5>'.$row['qt_ans3'].' </h5>';
                                                                }

                                                                if($row['qt_ans4'] == $row['qt_crct'])
                                                                {
                                                                    echo '<h5 class="txt">'.$row['qt_ans4'].' </h5>';
                                                                }
                                                                else
                                                                {
                                                                    echo '<h5>'.$row['qt_ans4'].' </h5>';
                                                                }
                                                            ?>
                                                        </h5>
                                                        <hr>
                                                        <p class="product-description">
                                                            <?php
                                                            if(isset($t['qa_subans']))
                                                            {
                                                                if($t['qa_subans'] == $row['qt_crct'])
                                                                {
                                                                    echo '<h5 class="txt">'.$t['qa_subans'].' </h5>';
                                                                } 
                                                                else
                                                                {
                                                                    echo '<h5 class="txt1">'.$t['qa_subans'].' </h5>';
                                                                }
                                                            }
                                                            else
                                                            {
                                                                echo '<h5 class="txt1">Not answered </h5>';
                                                            }
                                                            ?>
                                                        </p>
                                                    </div>
