                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="card project_list">
                            <div class="table-responsive">
                                <form action="../../php/t_attProcess.php" method="post" id="form">
                                                    ...
                                                    <td>
                                                        ...
                                                        if (isset($t['at_p1'])) {
                                                            if ($t['at_p1'] == 0) {
                                                                ...
                                                                <input type="radio" name="p1[<?php echo $i ?>]" value="0" checked> Absent
                                                                <?php
                                                            } else {
                                                                ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        if (isset($t['at_p2'])) {
                                                            if ($t['at_p2'] == 0) {
                                                                ...
                                                                <input type="radio" name="p2[<?php echo $i ?>]" value="0" checked> Absent
                                                                <?php
                                                            } else {
                                                                ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        if (isset($t['at_p3'])) {
                                                            if ($t['at_p3'] == 0) {
                                                                ...
                                                                <input type="radio" name="p3[<?php echo $i ?>]" value="0" checked> Absent
                                                                <?php
                                                            } else {
                                                                ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        if (isset($t['at_p4'])) {
                                                            if ($t['at_p4'] == 0) {
                                                                ...
                                                                <input type="radio" name="p4[<?php echo $i ?>]" value="0" checked> Absent
                                                                <?php
                                                            } else {
                                                                ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        if (isset($t['at_p5'])) {
                                                            if ($t['at_p5'] == 0) {
                                                                ...
                                                                <input type="radio" name="p5[<?php echo $i ?>]" value="0" checked> Absent
                                                                <?php
                                                            } else {
                                                                ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        if (isset($t['at_p6'])) {
                                                            if ($t['at_p6'] == 0) {
                                                                ...
                                                                <input type="radio" name="p6[<?php echo $i ?>]" value="0" checked> Absent
                                                                <?php
                                                            } else {
                                                                ?>
